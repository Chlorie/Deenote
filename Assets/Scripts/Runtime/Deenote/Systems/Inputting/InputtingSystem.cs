...
namespace Deenote.Systems.Inputting
{
    public static class InputtingSystem
    {
        ...
        private static bool IsKeyOfState(KeyCode key, KeyState state)
             => state switch {
        ...
        {
            return binding.Modifiers == checkedModifiers && IsKeyOfState(binding.Key, binding.State);
        }
    }
}