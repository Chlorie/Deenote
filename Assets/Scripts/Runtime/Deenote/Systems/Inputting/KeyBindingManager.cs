...
{
    public sealed class KeyBindingManager : MonoBehaviour
    {
        ...
        private FrameCachedProperty<KeyModifiers> _activeModifiers = new(InputtingSystem.GetPressedModifierKeys);
