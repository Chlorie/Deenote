...
namespace Deenote.GamePlay
{
    ...
    public sealed partial class NotesManager
    {
        ...
        private ObjectPool<GamePlayNoteController> _pool = default!;
        private readonly List<GamePlayNoteController> _activeNotes = default!;
        /// <summary>
        ...
        /// </remarks>
        private readonly List<GamePlayNoteController> _pendingNotes = default!;
        ...
        internal ReadOnlySpan<GamePlayNoteController> ActiveNotes => _activeNotes.AsSpan();
        internal ReadOnlySpan<GamePlayNoteController> PendingNotes => _pendingNotes.AsSpan();
        ...
        internal void Initialize(GamePlayNoteController notePrefab, GameStageControllerBase stage)
        {
        ...
        private void RemoveAllPendingNotes(Predicate<GamePlayNoteController> predicate)
        {
            var pool = _pool;
        ...
        private GamePlayNoteController AddActiveNote(NoteModel note)
        {
            var item = _pool.Get();
        ...
        private GamePlayNoteController AddPendingNote(NoteModel note)
        {
