...
public class UpdateHistory : MonoBehaviour
{
    ...
    public LocalizedText_Legacy text;
    public LocalizedText_Legacy title;
    public LocalizedText_Legacy checkUpdateText;
    ...
    private readonly List<string> versions = new List<string>
    {
        ...
        "Deenote 0.5.5", "Deenote 0.5.4", "Deenote 0.5.3", "Deenote 0.5.2", "Deenote 0.5.1", "Deenote 0.5",
        "Deenote 0.4",
        "Deenote 0.3.1", "Deenote 0.3 build 2", "Deenote 0.3 build 1",
        "Deenote 0.2.1", "Deenote 0.2",
        "Deenote 0.1",
    ...
    private readonly List<string[]> updateInfo = new List<string[]>
    {
        ...
        new[]{ "Added localization support for Chinese.\nFixed some minor bugs.\nCollided notes are tinted red now.",
            "增加了中文的本地化支持。\n修复了一些小漏洞。\n重叠note现在会显示红色。" },
        new[]{ "Optimized the file format so that the project file won't take much space.",
            "优化了文件格式，项目文件将占用更少空间。" },
        new[]{ "Added \"mirror\" function.\nAdded shortcut for adjusting note size.\nNow when you paste while " +
        ...
        new[]{ "Added \"Note ID\" field in selected note info panel.\nBug fix: Slide notes not exported correctly.\n" +
            "Bug fix: Export file name is not correct.",
            "在选中note信息中添加了note编号域。\n修复漏洞：滑键导出格式不正确。\n修复漏洞：导出文件名不正确。" },
        new[]{ "Now the app should not have problem closing itself.\nAdded options for resizing the window.",
            "现在关闭app应该不会出现问题了。\n增加了调整窗口大小的设置项。" },
        new[]{ "Bug fix: After opening the tutorial all the inputs are ignored.",
            "修复漏洞：打开教程后所有输入都被忽略。"},
        new[]{ "Added Chinese tutorial to this app. English tutorial coming soon.",
            "添加了中文教程。英文教程即将更新。" },
        new[]{ "Added curve forming function.",
            "添加了曲线生成功能。" },
        new[]{ "Now saving and loading files won't block the main thread.\nFixed the serious bug about music " +
            "playback repositioning.",
            "现在保存和读入文件不会再阻塞主线程了。\n修复了关于音乐回放位置的严重漏洞。" },
        new[]{ "Separated update history from about.\nAdded update checker.\nMinor bug fixes about UI.",
            "将更新历史从关于中分离出来。\n添加了更新检测。\n修复用户界面的一些小漏洞。" },
        new[]{ "Now you can change the music file used in the project.\nWhen creating a new file in the file " +
            "selector, files with the target extension will appear.",
            "现在你可以替换项目中使用的音乐文件了。\n创建新文件时同后缀名的已有文件也会在文件选择窗口中显示。" },
        new[]{ "Bug fix: File cannot be opened.\nBug fix: Link lines cannot be toggled off.\n" +
            "Deleted Schwarzer’s famous words because I don’t want to die. XD",
            "修复漏洞：不能打开文件。\n修复漏洞：滑键连线不能关闭。\n删除了Schwarzer的名言，我还不想死（" },
        new[]{ "Added drag-and-drop file opener. (Thanks to Schwarzer!)",
            "添加了拖动文件到窗口打开文件的功能。（感谢Schwarzer！）" },
        new[]{ "Added support for mp3 music files.",
            "添加了对MP3音乐文件的支持。" },
        new[]{ "Completely reworked on the code of line displaying.",
            "彻底重写了连线显示的代码。" },
        new[]{ "Added toggle for VSync.\nNow editor settings are saved as well.",
            "添加了垂直同步的开关。\n现在编辑器设置也会被自动保存。" },
        new[]{ "Changed default volume of piano sounds from 127 to 0.\nNow you can import ogg music files.",
            "将钢琴音的默认音量从127调整为0。\n现在你可以导入OGG音乐文件了。" },
        new[]{ "Fixed the bug when deleting slide notes the remaining slide notes are incorrectly linked.",
            "修复了删除滑键时剩余的滑键会连接错误的漏洞。" },
        new[]{ "Copy/Paste functions.\nQuantize notes.",
            "复制/粘贴功能。\n量化note功能。" },
        new[]{ "Full edit function of note properties.",
            "全部note属性编辑功能。" },
        new[]{ "File extension association.",
            "文件后缀名关联。" },
        new[]{ "Minor changes to beat line saving.\nEdit panel UI redesigned.",
            "稍微更改了拍线存储方式。\n重新设计了编辑板块的UI。" },
        new[]{ "Bug fixes.", "漏洞修复。" },
        new[]{ "Add new notes.\nLink/Unlink selected notes.\nNote placement indicator.",
            "添加新note。\n连接/断开选中note。\nNote摆放位置指示。" },
        new[]{ "Added color tint for selected notes.\nRemove notes.\nBeat line filling field auto-fill.",
            "选中note染色。\n删除note。\n拍线填充域自动填充。" },
        new[]{ "Added all visual effects for chart viewing function.\nAdded a manual BPM calculator.\nVolume control " +
        ...
        new[]{ "Added some shortcuts.\nJSON file exporting.\n\"Save as\" feature.\nAdded some visual effects " +
            ...
            "冲击波和圆形特效）。\n修复了一些漏洞。" },
        new[]{ "Chart viewing function finished. No effects yet.", "完成了谱面预览功能。目前还没有特效。" }
    };
    private int current;
